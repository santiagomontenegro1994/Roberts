...
$ListadoProveedores = Listar_Proveedores_Insumos($MiConexion);
$CantidadProveedores = count($ListadoProveedores);
  ...
  //estoy en condiciones de poder buscar segun el parametro
    ...
    if (!empty($_POST['BotonBuscar'])) {
        ...
        $ListadoProveedores=Listar_Proveedores_Insumos_Parametro($MiConexion,$criterio,$parametro);
        $CantidadProveedores = count($ListadoProveedores);
...
<div class="pagetitle">
  <h1>Listado Proveedores insumos</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="../core/index.php">Menu</a></li>
      <li class="breadcrumb-item">Proveedores insumos</li>
      <li class="breadcrumb-item active">Listado Proveedores insumos</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
...
<section class="section">
    ...
    <div class="card">
        <div class="card-body">
          <h5 class="card-title">Listado Proveedores insumos</h5>
