...
$ListadoTiposMovimiento = Listar_Tipos_Movimiento_Contable($MiConexion);
...
<div class="pagetitle d-flex justify-content-between align-items-center">
  <h1>Listado Tipos de Movimientos (Contable)</h1>
</div>
    ...
    <div class="card">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            <h5 class="card-title mb-0">Listado Tipos de Movimientos (Contable)</h5>
