...
<div class="bg-white p-3 d-flex align-items-center shadow-sm sticky-top">
    ...
    <h5 class="m-0 fw-bold">Carga Rápida</h5>
</div>

<div class="container py-5 text-center d-flex flex-column justify-content-center align-items-center" style="min-height: 75vh;">
    <div class="rounded-circle d-flex align-items-center justify-content-center mb-4 shadow-sm" style="width: 120px; height: 120px; background-color: #e8f8f5;">
        <i class="bi bi-cone-striped text-success" style="font-size: 3.5rem;"></i>
    </div>
    
    <h3 class="fw-bold text-dark mb-2">Módulo en Construcción</h3>
    <p class="text-muted mb-5 px-3" style="font-size: 1.1rem;">
        Estamos preparando esta sección para que puedas mandar trabajos directo al taller en tiempo récord. ¡Estará lista muy pronto!
    </p>
