...
$TiposMovimientos = Listar_Tipos_Pagos_Contable($MiConexion);
            ...
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <div class="text-center mb-4 d-flex justify-content-between align-items-center">
                        ...
                        <a href="../imprenta_metodos_pago/agregar_metodo_pago.php" class="btn btn-outline-primary btn-sm">Gestionar Tipos de Pagos</a>
                    </div>
                    <div class="d-flex flex-wrap justify-content-center">
                        <?php foreach ($TiposPagos as $tipo) { ?>
                            <button type="button" class="btn btn-secondary mx-2 my-2 tipo-movimiento" data-id="<?php echo $tipo['idTipoPago']; ?>">
