                                ...
                                <tr class="<?php echo $Color; ?>" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-original-title="<?php echo $Title; ?>">
                                    ...
                                    <td>
                                        <select name="estado_detalle[<?php echo $detalle['ID_DETALLE']; ?>]" class="form-control">
                                            <option value="1" <?php echo ($detalle['ESTADO'] == 1) ? 'selected' : ''; ?>>P/PEDIR</option>
                                            <option value="2" <?php echo ($detalle['ESTADO'] == 2) ? 'selected' : ''; ?>>PEDIDO</option>
                                            <option value="3" <?php echo ($detalle['ESTADO'] == 3) ? 'selected' : ''; ?>>RECIBIDO</option>
                                            <option value="4" <?php echo ($detalle['ESTADO'] == 4) ? 'selected' : ''; ?>>ENTREGADO</option>
                                        </select>
                                    </td>
                                    <td>
