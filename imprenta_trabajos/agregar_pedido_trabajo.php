...
<style>
    /* Reducir padding y margen generales */
    .card-body {
    ...
    /* Margen más reducido entre filas */
    .row.mb-3 {
    ...
    /* Para que el botón quede alineado en la fila inferior */
    #add_trabajo_pedido {
        font-size: 0.9rem;
        padding-left: 0;
        padding-right: 0;
    ...
    /* Ajustes en layout de filas de Datos del Pedido */
    .datos-pedido-row {
        margin-bottom: 0.5rem;
        align-items: flex-end;
    }

    /* Ajustar columna botón agregar para que quede alineado */
    .btn-agregar-col {
        display: flex;
